...
if (!function_exists('pb_posted_on')) :
    ...
    function pb_posted_on()
    {
        ...
        /* translators: %s: post date. */
            esc_html_x('Posted on %s', 'post date', 'pb'), '<span class="font-weight-bold">' . $time_string . '</span>'
        );
...
if (!function_exists('pb_posted_by')) :
    ...
    function pb_posted_by()
    {
        ...
        /* translators: %s: post author. */
            esc_html_x('by %s', 'post author', 'pb'), '<span class="author vcard font-weight-bold">' . esc_html(get_the_author()) . '</span>'
        );
            ...
            comments_popup_link(
                sprintf(
                    ...
                    /* translators: %s: post title */
                        __('Leave a Comment<span class="screen-reader-text"> on %s</span>', 'pb'), array(
                            'span' => array(
                                'class' => array(),
                            ),
                        )
        ...
        edit_post_link(
            sprintf(
                ...
                /* translators: %s: Name of current post. Only visible to screen readers */
                    __('Edit <span class="screen-reader-text">%s</span>', 'pb'), array(
                        'span' => array(
                            'class' => array(),
                        ),
                    )
...
if (!function_exists('pb_post_thumbnail')) :
    ...
    function pb_post_thumbnail()
    {
        ...
        <?php else : ?>
            <?php
            the_post_thumbnail('post-thumbnail', ['class' => 'img-fluid'], array(
